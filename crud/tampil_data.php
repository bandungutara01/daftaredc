    ...
    <div class="ms-5 ms-lg-0 pt-lg-2">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?halaman=data" class="text-dark text-decoration-none">Daftar EDC</a></li>
...
<div class="row flex-lg-row-reverse align-items-center mb-5">
    ...
    <div class="col-lg-4 col-xl-3">
        <a href="?halaman=entri" class="btn btn-primary rounded-pill float-lg-end py-2 px-4 mb-4 mb-lg-0">
            <i class="fa-solid fa-plus me-2"></i> Entri Data EDC
        </a>
    </div>
    <!-- form pencarian -->
    <div class="col-lg-8 col-xl-9">
        <form action="?halaman=pencarian" method="post" class="form-search needs-validation" novalidate>
            <input type="text" name="kata_kunci" class="form-control rounded-pill" placeholder="Cari Data EDC ..." autocomplete="off" required>
            <div class="invalid-feedback">Masukan ID atau Nama EDC.</div>
        </form>
    </div>
</div>
...
<div class="row mb-5">
    ...
    */
    ...
    $query = $mysqli->query("SELECT id_siswa, kelas, alamat, email, whatsapp, nama_lengkap, foto_profil FROM tbl_siswa
            ...
            <div class="p-2">
                <div class="d-flex bg-white rounded-4 shadow-sm">
                    ...
                    <div class="p-4 flex-grow-1">
                        ...
                        <p class="text-muted">Bank EDC : <?php echo $data['kelas']; ?></p>
                        <p class="text-muted">MDR On Us : <?php echo $data['alamat']; ?></p>
                        <p class="text-muted">MDR Off Us : <?php echo $data['email']; ?></p>
                        <p class="text-muted">MDR Qris : <?php echo $data['whatsapp']; ?></p>
                    </div>
                    <div class="p-4">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">
                                <i class="fa-regular fa-trash-can me-2"></i> Hapus Data EDC
                            </h1>
                        </div>
                        <div class="modal-body">
                            <p class="mb-2">Anda yakin ingin menghapus data EDC?</p>
