...
<head>
    ...
    <!-- Title -->
    <title>Aplikasi Daftar EDC</title>
        ...
        <nav class="navbar navbar-expand-lg fixed-top bg-primary shadow">
            <div class="container">
                <span class="navbar-brand text-white">
                    ...
                    Aplikasi <span class="d-none d-md-inline">Daftar EDC</span>
                </span>
            </div>
        </nav>
    </header>
    ...
    <footer class="footer mt-auto bg-white shadow py-4">
        <div class="container">
            ...
            <div class="copyright text-center mb-2 mb-md-0">
                &copy; 2024 - <a href="#" target="_blank" class="text-brand text-decoration-none">Ujang Wara</a>. All rights reserved.
            </div>
        </div>
    </footer>
